...
<div class="p-6 bg-light-blue min-h-screen">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
        ...
        <div class="bg-white shadow-lg rounded-lg p-6">
            ...
            <div class="space-y-2">
                <p><span class="font-bold text-gray-700">Nombre:</span> Abraham Pérez Navor</p>
                <p><span class="font-bold text-gray-700">Correo Electrónico:</span> abraham.perez@example.com</p>
                <p><span class="font-bold text-gray-700">Teléfono:</span> +52 442 123 4567</p>
                <p><span class="font-bold text-gray-700">Rol:</span> Administrador</p>
            </div>
        </div>
        ...
        <div class="flex flex-col items-center bg-white shadow-lg rounded-lg p-6">
            ...
            <h2 class="mt-4 text-lg font-bold text-gray-800">MDG2309AC</h2>
            <p class="text-gray-600">Administrador</p>
        </div>
    </div>

    <!-- Configuración del Usuario -->
    <div class="mt-8 bg-white shadow-lg rounded-lg p-6">
        <h2 class="text-lg font-bold text-gray-800 mb-4">Configuraciones</h2>
            ...
            <div class="p-6 space-y-4">
                <form method="POST" action="#">
                    ...
                    <div>
                        ...
                        <input type="text" id="name" name="name" value="Abraham Pérez Navor"
                            class="w-full border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div>
                        <label for="email" class="block text-sm font-medium text-gray-700">Correo Electrónico</label>
                        <input type="email" id="email" name="email" value="abraham.perez@example.com"
                            class="w-full border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div>
                        <label for="phone" class="block text-sm font-medium text-gray-700">Teléfono</label>
                        <input type="text" id="phone" name="phone" value="+52 442 123 4567"
                            class="w-full border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                    </div>
