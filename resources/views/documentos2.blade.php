    ...
    <div class="w-1/5 bg-gray-100 shadow-lg p-4 border-r border-black overflow-y-auto">
      ...
      <nav>
        <ul>
          ...
          <li class="py-2"><a href="#" class="text-gray-700 flex items-center"><i class="fas fa-user mr-2"></i>Mi perfil</a></li>
          <li class="py-2">
            <p class="text-gray-700">Documentos</p>
            <ul class="pl-4 mt-2 space-y-1">
              <li class="flex items-center text-blue-700"><i class="fas fa-circle mr-2 text-xs"></i>Mis Documentos</li>
              <li class="flex items-center"><i class="fas fa-circle mr-2 text-xs text-gray-500"></i>Compartidos</li>
            </ul>
          </li>
        </ul>
      </nav>
      ...
      <div class="mt-6">
        ...
        <div class="mt-4">
          ...
          <div class="grid grid-cols-4 gap-4">
            <div class="bg-gray-200 p-4 flex items-center justify-center h-56 w-3/4 rounded-lg">
        ...
        <div class="mt-6">
          <h4 class="text-lg font-semibold text-gray-800 mb-2">Documentos Compartidos</h4>
          <div class="grid grid-cols-4 gap-4">
            <div class="bg-gray-200 p-4 flex items-center justify-center h-56 w-3/4 rounded-lg">
              <p class="text-center font-bold text-gray-700">Doc</p>
            </div>
        ...
        <div class="mt-6">
          <h4 class="text-lg font-semibold text-gray-800 mb-2">Historial de Documentos</h4>
          <div class="grid grid-cols-4 gap-4">
            <div class="bg-gray-200 p-4 flex items-center justify-center h-56 w-3/4 rounded-lg">
              <p class="text-center font-bold text-gray-700">Doc</p>
            </div>
